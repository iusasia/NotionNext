...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LMCG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'The Learning Management Committee Group', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'lmcg.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'LMCG', // 网站关键词 英文逗号隔开
  ...
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || '"Times New Roman"',
